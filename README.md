...
This folder collects the source files that were relevant to the  patch work.
...
- `patches/src/main/kotlin/app/revanced/patches/chzzk/cheatkey/Fingerprints.kt`
  ...
  - Identifies  classes such as `CheatKeyStatus`, `CheatKeyInfo`, `StreamingLiveStatus`, `StreamingLiveItem`, and `PlayableAd.Data`.

- `patches/src/main/kotlin/app/revanced/patches/chzzk/shared/Constants.kt`
  -  package/version compatibility.
  - Target version is  `3.6.2`.

## Existing Patches Also Included

- `patches/src/main/kotlin/app/revanced/patches/chzzk/p2p/DisableP2PPatch.kt`
  - Disables  P2P/grid streaming behavior.
...
- `patch_apps.sh`
  ...
  - version support was updated during this work.

## Analysis Report

- `_CHEATKEY_ANALYSIS_REPORT.md`
